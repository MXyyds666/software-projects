...
#define KEY_BUTTON_S5_GPIO_PORT          GPIOA
#define KEY_BUTTON_S5_GPIO_CLK           RCC_AHB_PERIPHEN_GPIOA
#define KEY_BUTTON_S5_PIN                GPIO_PIN_0
#define KEY_BUTTON_S5_PORT_SOURCE        GPIOA_PORT_SOURCE
#define KEY_BUTTON_S5_PIN_SOURCE         GPIO_PIN_SOURCE0
