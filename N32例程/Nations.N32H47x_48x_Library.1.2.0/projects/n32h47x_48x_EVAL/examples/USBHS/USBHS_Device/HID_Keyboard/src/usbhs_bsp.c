...
void KEY_Init(void)
{
    ...
    GPIO_InitStructure.Pin            = KEY_BUTTON_S5_PIN ;
    GPIO_InitStructure.GPIO_Pull      = GPIO_NO_PULL;
    GPIO_InitPeripheral(KEY_BUTTON_S5_GPIO_PORT, &GPIO_InitStructure);
}
...
void USB_BSP_EnableInterrupt(USB_CORE_MODULE *USBx)
{
    ...
    GPIO_ConfigEXTILine(EXTI_LINE_SOURCE0, KEY_BUTTON_S5_PORT_SOURCE, KEY_BUTTON_S5_PIN_SOURCE);
}
