...
/** @addtogroup AT32F456_periph_template
  * @{
  */

/** @addtogroup 456_System_clock_configuration System_clock_configuration
  * @{
  */
...
void system_clock_config(void)
{
   ...
   * 使用的是16M外部晶振
   */
	crm_pll_config(CRM_PLL_SOURCE_HEXT, 72, 1, CRM_PLL_FP_6);
